...
export declare class AgendaViewInternalComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AgendaViewInternalComponent, "agenda-view-internal", never, { "eventTemplate": "eventTemplate"; "slotClass": "slotClass"; "eventClass": "eventClass"; "eventStyles": "eventStyles"; "agendaTimeTemplate": "agendaTimeTemplate"; "agendaDateTemplate": "agendaDateTemplate"; "selectedDateFormat": "selectedDateFormat"; "selectedShortDateFormat": "selectedShortDateFormat"; "numberOfDays": "numberOfDays"; }, {}, never, never, true, never>;
}
