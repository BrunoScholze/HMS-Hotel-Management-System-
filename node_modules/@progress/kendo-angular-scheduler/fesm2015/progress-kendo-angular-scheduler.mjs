...
import { Directive, Optional, Injectable, EventEmitter, Input, Inject, isDevMode, Component, HostBinding, Output, forwardRef, ViewChild, ViewChildren, ChangeDetectionStrategy, NgZone, ViewContainerRef, ContentChild, ContentChildren, HostListener, LOCALE_ID, ElementRef, Pipe, TemplateRef, NgModule } from '@angular/core';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: AgendaTaskItemComponent, decorators: [{
    ...
    `,
        ...
        return [{ type: i1$1.LocalizationService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [LOCALE_ID]
                    }] }];
    }, propDecorators: { item: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: MonthViewItemComponent, decorators: [{
    ...
    `,
        ...
        return [{ type: MonthSlotService }, { type: i1$1.LocalizationService }, { type: FocusService }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [LOCALE_ID]
                    }] }];
    } });
...
class DayTimeSlotService extends BaseSlotService {
    ...
    layoutTimeline(eventHeight, resourceRows) {
        ...
        this.groups.forEach((group, index) => {
            var _a;
            group.initTimeSlots(rowHeight, eventHeight, resourceRows && resourceRows[index] ? (_a = resourceRows[index].nativeElement.children[0]) === null || _a === void 0 ? void 0 : _a.children[0].offsetHeight : 0);
        });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: DayTimeViewItemComponent, decorators: [{
    ...
    `,
        ...
        return [{ type: i1$2.IntlService }, { type: DayTimeSlotService }, { type: i1$1.LocalizationService }, { type: FocusService }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [LOCALE_ID]
                    }] }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: YearViewInternalComponent, decorators: [{
    ...
    `,
        ...
        return [{ type: i1$1.LocalizationService }, { type: FocusService }, { type: i1$2.IntlService }, { type: ViewContextService }, { type: ViewStateService }, { type: i0.NgZone }, { type: i0.Renderer2 }, { type: PDFService }, { type: i0.ElementRef }, { type: MonthSlotService }, { type: i7.ScrollbarWidthService }, { type: i0.ChangeDetectorRef }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [LOCALE_ID]
                    }] }];
