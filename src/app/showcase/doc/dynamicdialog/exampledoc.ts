...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-content-center">
            <p-toast />
            <p-button (onClick)="show()" icon="pi pi-search" label="Select a Product6" />
        </div>
...
export class ExampleDoc implements OnDestroy {
    ...
    code: Code = {
        basic: `<p-toast />
<p-button (onClick)="show()" icon="pi pi-search" label="Select a Product 8" />`,

        html: `<div class="card flex justify-content-center">
    <p-toast />
    <p-button (onClick)="show()" icon="pi pi-search" label=" 9" />
</div>`,
